...
class CodeSummarizationDataset(Dataset):
    def __init__(self, jsonl_file, tokenizer, max_source_length=256, max_target_length=128):
...
def train_model(model_name, bits, data_file, train_file, valid_file, test_file, 
    ...
    train_dataset = CodeSummarizationDataset(train_file, tokenizer, 
                                             model_config.max_source_length, 
                                             model_config.max_target_length)
    eval_dataset = CodeSummarizationDataset(valid_file, tokenizer,
                                           model_config.max_source_length,
                                           model_config.max_target_length)
